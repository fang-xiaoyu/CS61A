...
class Card(object):
    ...
    #run_docstring_examples(__init__, globals(), True)
...
class Player(object):
    ...
    #run_docstring_examples(draw, globals(), True)
    ...
    #run_docstring_examples(play, globals(), True)
...
class TutorCard(Card):
    ...
    #run_docstring_examples(effect, globals(), True)
...
class InstructorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for card in self.desk:
            card += (300, 300)
        self.desk.append(other_card.copy())
        self.hand.cards.append(other_card.copy())
        #Uncomment the line below when you've finished implementing this method!
